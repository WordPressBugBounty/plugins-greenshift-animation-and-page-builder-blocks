...
* Update: Removed aria-hidden for accordion block

= 12.9.2 =

* Added: GPT Image 2 model for image generation
...
* Added: Improved security for Image block, API Connector, Global Color API. 
* Added: Improved Agent system for AI Helper (works properly only with WP 7.0 and newer)
* Added: Updated Skills for AI Agents (find it in skills folder in plugin)

= 12.8.8 =

* Added: improved export/import for reusable templates
* Added: improved navigation element menu for cases when you have a lot of menu items on mobile navigation
* Added: improved svg support from convertors

= 12.8.7 =

* Added: Font weight in typography (old) panels are device related now
* Added: Support for updated iframe editor for upcoming WP 7.0

= 12.8.6 =

* Added: Box sizing option added to containers automatically if width, height, minHeight or maxHeight is set
* Added: Improved security for dynamic atributes.
* Added: Improved style rendering for AI agentic code generation 
* Added: Image and Video Elements blocks now support dynamic placeholders for src and alt attributes

= 12.8.5 =

* Added: Background option in GS blocks are devices related now as for GL Elements
* Added: Better semantic table element default preset 
* Added: Updated models for AI helper
* Added: Ability for changing global variables for Ability API

= 12.8.4 =

* Added: Improved security for dynamic style rendering and dynamic pattern loading
* Added: Wp Abilities for upcoming AI core features
* Added: Updated models for AI helper
* Added: Improved Stylebook UI for color variables
* Added: Pattern overrides support now Classes for block override

= 12.8.3 =

* Added: Improved security for reusable blocks ajax loading

= 12.8.2 =

* Added: Class hiding works only for style manager block
* Added: More Dynamic placeholders 
* Added: Dynamic placeholders are executed immediately if it's placed in query builder 
