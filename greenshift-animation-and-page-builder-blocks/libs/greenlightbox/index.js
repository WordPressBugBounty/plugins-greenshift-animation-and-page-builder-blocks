...
`;document.body.insertAdjacentHTML("beforeend",e)}initLinks(){document.querySelectorAll("[data-gs-lightbox]").forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();let i=e.getAttribute(this.options.linkAttribute)||e.getAttribute("data-lightbox-src");i&&this.open(i,e)})})}open(e,t){if(this.content.innerHTML="",this.triggerElement=t,"string"==typeof e){if(null!==e.match(/\.(jpeg|jpg|gif|png)$/)){let i=document.createElement("img");i.src=e,i.alt="Lightbox Image",this.content.appendChild(i)}else if(e.includes("youtube.com")||e.includes("youtu.be")){let o=this.getYouTubeId(e);this.createResponsiveVideo(`https://www.youtube.com/embed/${o}`)}else if(e.includes("vimeo.com")){let l=this.getVimeoId(e);this.createResponsiveVideo(`https://player.vimeo.com/video/${l}`)}else null!==e.match(/\.(mp4)$/)&&this.createResponsiveVideo(e,!0)}else if(e instanceof HTMLElement){let s=e;if(s&&"function"==typeof s.cloneNode)try{let n=s.cloneNode(!0);n.style.display="block",this.content.appendChild(n)}catch(r){console.error("Failed to clone element:",r)}else s&&(this.content.innerHTML=s.outerHTML||s.textContent)}this.lightbox.classList.add("active"),this.lightbox.setAttribute("aria-hidden","false"),this.content.focus()}createResponsiveVideo(e,t=!1){let i=document.createElement("div");if(i.className="gs-lightbox-video-wrapper",t){let o=document.createElement("video");o.src=e,o.controls=!0,o.autoplay=!0,i.appendChild(o)}else if(e.includes("youtube.com")||e.includes("youtu.be")){let l=this.getYouTubeId(e),s=document.createElement("div");s.id="gs-youtube-player",i.appendChild(s),this.loadYouTubeAPIAndCreatePlayer(l,s)}else{let n=document.createElement("iframe");(e.includes("youtube.com")||e.includes("youtu.be"))&&(e+=(e.includes("?")?"&":"?")+"autoplay=1"),n.src=e,n.frameBorder="0",n.allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",n.allowFullscreen=!0,i.appendChild(n)}this.content.appendChild(i)}loadYouTubeAPIAndCreatePlayer(e,t){if(window.YT&&window.YT.Player)this.createYouTubePlayer(e,t);else{let i=document.createElement("script");i.src="https://www.youtube.com/iframe_api";let o=document.getElementsByTagName("script")[0];o.parentNode.insertBefore(i,o),window.onYouTubeIframeAPIReady=()=>{this.createYouTubePlayer(e,t)}}}createYouTubePlayer(e,t){new window.YT.Player(t,{height:"100%",width:"100%",videoId:e,playerVars:{autoplay:1},events:{onReady(e){e.target.getIframe().focus()}}})}close(){this.lightbox.classList.remove("active"),this.lightbox.setAttribute("aria-hidden","true"),this.triggerElement&&this.triggerElement.focus(),setTimeout(()=>{this.content.innerHTML=""},300)}getYouTubeId(e){let t=e.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/);return t&&11===t[2].length?t[2]:null}getVimeoId(e){let t=e.match(/vimeo.*\/(\d+)/i);return t?t[1]:null}}let greenLightbox;function openGreenlightbox(e,t){greenLightbox&&greenLightbox.open(e,t)}document.addEventListener("DOMContentLoaded",()=>{greenLightbox=new GSLightbox});