...
`;document.body.insertAdjacentHTML("beforeend",e)}open(e,t){if(this.content.innerHTML="",this.triggerElement=t,e instanceof HTMLElement){let n=e;if(n&&"function"==typeof n.cloneNode)try{let i=n;i.classList.add("gs-panel-initial"),this.content.appendChild(i),setTimeout(()=>{i.classList.add("active"),i.classList.remove("gs-panel-initial"),document.body.style.overflow="hidden"},10)}catch(s){console.error("Failed to clone element:",s)}else n&&(this.content.innerHTML=n.outerHTML||n.textContent)}(setTimeout(()=>{this.dynamicpanel.classList.add("active")},10),this.triggerElement&&this.triggerElement.classList.add("triggeractive"),this.dynamicpanel.setAttribute("aria-hidden","false"),this.content.querySelector(".gs-panel-close"))?this.content.querySelectorAll(".gs-panel-close").forEach(e=>{e.addEventListener("click",()=>this.close())}):this.dynamicpanel.querySelector(".gs-dynamicpanel-close")||(this.closeBtn=document.createElement("button"),this.closeBtn.classList.add("gs-dynamicpanel-close"),this.closeBtn.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',this.dynamicpanel.appendChild(this.closeBtn),this.closeBtn.addEventListener("click",()=>this.close())),this.content.focus()}close(){this.dynamicpanel.classList.remove("active"),this.dynamicpanel.setAttribute("aria-hidden","true"),this.content.classList.remove("active"),this.content.querySelector(".active").classList.remove("active"),document.body.style.overflow="auto",this.triggerElement&&this.triggerElement.classList.remove("triggeractive"),this.triggerElement&&this.triggerElement.focus()}}let greenDynamicPanel;function openGreendynamicpanel(e,t){greenDynamicPanel&&greenDynamicPanel.open(e,t)}document.addEventListener("DOMContentLoaded",()=>{greenDynamicPanel=new GSDynamicPanel});