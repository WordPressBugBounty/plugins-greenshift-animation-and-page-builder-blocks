...
if ($stylebook_post_id) {
    ...
    $stylebooklink = esc_url(admin_url('admin.php?page=greenshift_stylebook'));
}
?>
...
<div class="wp-block-greenshift-blocks-container gspb_container gspb_container-gsbp-ecfa9f32-682f" id="gspb_container-id-gsbp-ecfa9f32-682f">
    <div class="wp-block-greenshift-blocks-container gspb_container gspb_container-gsbp-306c24ec-8b8e" id="gspb_container-id-gsbp-306c24ec-8b8e">
        <div class="wp-block-greenshift-blocks-container gspb_container gspb_container-gsbp-e6dccbfa-f119" id="gspb_container-id-gsbp-e6dccbfa-f119">
            <div class="wp-block-greenshift-blocks-image gspb_image gspb_image-id-gsbp-1286d0f0-1ae9" id="gspb_image-id-gsbp-1286d0f0-1ae9"><img decoding="async" loading="lazy" src="<?php echo esc_url(GREENSHIFT_DIR_URL . 'templates/admin/img/icon.png'); ?>" data-src="" alt="" height="22"></div>


            <div id="gspb_text-id-gsbp-d1cca294-fdf1" class="gspb_text gspb_text-id-gsbp-d1cca294-fdf1 "><mark style="background-color:rgba(0, 0, 0, 0);color:#714b8f" class="has-inline-color"><?php if ($plugin_version) echo 'V' . esc_attr($plugin_version); ?></mark> – <?php if ($pluginName) {echo esc_attr($pluginName);
            } else {
        ...
        <div class="wp-block-greenshift-blocks-iconlist gspb_iconsList gspb_iconsList-id-gsbp-843b958c-d873" id="gspb_iconsList-id-gsbp-843b958c-d873">
            ...
            <div class="gspb_iconsList__item" data-id="5"><a class="gspb_iconsList__link" href="<?php echo esc_url($stylebooklink); ?>" rel="noopener"></a><svg class="" style="display:inline-block;vertical-align:middle" width="18" height="18" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="gspb_iconsList__item<?php echo $activetab == 'settings' ? ' active' : ''; ?>" data-id="1"><a class="gspb_iconsList__link" href="<?php echo esc_url(admin_url('admin.php?page=greenshift'));?>" rel="noopener"></a><svg class="" style="display:inline-block;vertical-align:middle" width="18" height="18" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"></svg>
            ...
            <div class="gspb_iconsList__item<?php echo $activetab == 'block_manager' ? ' active' : ''; ?>" data-id="6"><a class="gspb_iconsList__link" href="<?php echo esc_url(admin_url('admin.php?page=greenshift_block_manager'));?>" rel="noopener"></a>
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 108.04 108.04" xml:space="preserve"><path d="M29 5.493H0v29h29zm-5 24H5v-19h19zm68.915 42.804c-8.34 0-15.125 6.785-15.125 15.125s6.785 15.125 15.125 15.125 15.125-6.784 15.125-15.125c0-8.34-6.786-15.125-15.125-15.125m0 25.25c-5.582 0-10.125-4.542-10.125-10.125s4.543-10.125 10.125-10.125c5.584 0 10.125 4.542 10.125 10.125s-4.541 10.125-10.125 10.125M17.002 50.778h13.557v5H12.016V54.61h-.014V39.445h5zm73.413 5H75.059v-5h20.306v2.346h.051V68.29h-5zm-54.864-5.467 6.814 20.971h22.051l6.812-20.971L53.391 37.35zm25.233 15.971H45.999l-4.57-14.061 11.963-8.691 11.961 8.691z"/></svg>
            <span class="gspb_iconsList__item__text"><?php esc_html_e("Block Manager", 'greenshift-animation-and-page-builder-blocks'); ?></span></div>
            <div class="gspb_iconsList__item<?php echo $activetab == 'addons' ? ' active' : ''; ?>" data-id="2"><a class="gspb_iconsList__link" href="<?php echo esc_url(admin_url('admin.php?page=greenshift_dashboard-addons'));?>" rel="noopener"></a><svg class="" style="display:inline-block;vertical-align:middle" width="18" height="18" viewBox="0 0 1152 1024" xmlns="http://www.w3.org/2000/svg">
            ...
            <!--    <div class="gspb_iconsList__item<?php echo $activetab == 'demo' ? ' active' : ''; ?>" data-id="4"><a class="gspb_iconsList__link" href="<?php echo esc_url(admin_url('admin.php?page=greenshift_demo'));?>" rel="noopener"></a>
